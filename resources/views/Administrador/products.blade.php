        ...
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="../Administrador/img/EnbolsaSolochifles.jpg" alt="..." style="width: 600px; height: auto;"/>
        ...
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="../Administrador/img/Maduritos.PNG" alt="..." style="width: 600px; height: auto;"/>
...
function redirectToOrderForm() {
    window.location.href = '../Administrador/pedidosform.php';
}
        </script>
        <!-- Bootstrap core JS-->
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
        <!-- Core theme JS-->
        <script src="../Administrador/css/styles.css"></script>
    </body>
</html>
