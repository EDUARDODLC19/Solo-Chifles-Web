    ...
    <section class="order-form">
        ...
        <form id="orderForm" onsubmit="validateForm(event)">
            ...
            <div class="form-group">
                ...
                <input type="number" id="quantity" class="form-control" min="1" placeholder="Ingresa la cantidad" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="customerPhone" class="form-control" placeholder="Ingresa tu número de teléfono" required maxlength="10">
                <i class="fas fa-phone form-control-icon"></i>
            </div>            

            <div class="form-group">
                <label for="customerAddress" class="form-label">Dirección</label>
                <textarea id="customerAddress" class="form-control" rows="3" placeholder="Ingresa tu dirección completa" required></textarea>
