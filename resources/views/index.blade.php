            ...
            <div class="container">
                ...
                <div class="navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('products') }}">Catálogo de Productos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('store') }}">Contactos</a>
                        </li>
                        <li class="nav-item">
...
<div class="d-flex">
    <a href="logout.php" class="btn btn-warning btn-lg px-4 py-2 fw-bold text-dark shadow-sm">
            ...
            <div class="container">
                <div class="intro">
                    ...
                    <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                        ...
                        <p class="mb-3">Cada bocado de nuestros chifles artesanales comienza con ingredientes frescos y de origen local, preparados con dedicación y cuidado. Una vez que los pruebes, nuestros chifles se convertirán en una deliciosa adición a tus momentos especiales, ¡te lo garantizamos!</p>
                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
                            ...
                            <p class="mb-0">Cuando eliges "Solo Chifles", estamos comprometidos a ofrecerte un trato amable, una experiencia cálida y, sobre todo, productos de calidad excepcional, elaborados con los mejores ingredientes. Si no estás satisfecho, háznoslo saber y haremos todo lo posible para solucionarlo.</p>
                        </div>
                    </div>
                </div>
            </div>
