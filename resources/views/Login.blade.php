...
<body>
    <div class="login-container">
        ...
        <div class="logo-container">
            <img src="assets/img/logo transparebte.png" alt="Logo">
        </div>
        ...
        <div class="login-footer">
            <p>¿Olvidaste tu contraseña? <a href="#" data-bs-toggle="modal" data-bs-target="#forgotPasswordModal">Recupérala aquí</a></p>
            <p>¿No tienes una cuenta? <a href="#" data-bs-toggle="modal" data-bs-target="#registerModal">Regístrate</a></p>
        </div>
    </div>

    <!-- Modales (se mantienen como los tienes) -->
    <!-- Forgot Password Modal, Register Modal, Success Modals -->
